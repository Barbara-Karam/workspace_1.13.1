...
typedef struct{
	...
	volatile u32 CCR       ;//0x000			configration register
	volatile u32 CNDTR     ;//0x004    		no of data
	volatile u32 CPAR      ;//0x008			peripheral address
	volatile u32 CMAR      ;//0x00C			memory address
